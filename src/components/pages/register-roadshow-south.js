...
import RegistrationSection from './registration/individual-registration-roadshow-south';
...
export default ({ registrationState: { stage, errorDetails }, submitRegistration, submitPayment, resetRegistration, loadingEventDetails, eventDetails, registrationsOpen, currentPrice, registeredGroups }) => {
  return (
    <section className="container">
      <h3>Register for TYC Roadshow South</h3>
      {loadingEventDetails === true ?
        <LoadingMessage>Loading details of the event. This won't take long.</LoadingMessage>
        : (registrationsOpen === true ?
          ...
          <div className="alert alert-warning">
            Registrations for Roadshow South are not currently open.
          </div>
        )
      }
    </section>
