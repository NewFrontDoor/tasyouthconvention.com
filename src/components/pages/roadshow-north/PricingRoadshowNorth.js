      ...
      <div className="row">
        <div className="col-sm-6">
          <div className="white-bg">
            ...
            <p className="pddn-20-btm text-center"><Link to="/roadshow-north/register" className="btn btn-main-ghost">Register for Roadshow North</Link></p>
          </div>
        </div>
        <div className="col-sm-6">
          <div className="white-bg">
            ...
            <p className=" pddn-20-btm text-center"><Link to="/roadshow-north/register-group" className="btn btn-main-ghost">Register As a Leader</Link></p>
          </div>
        </div>
      </div>
      <div className="row">
