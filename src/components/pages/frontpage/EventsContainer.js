  ...
  <div id="events" className="homepage" style={{ 'backgroundImage': `url('${tycsplash}')`, fontFamily: 'Ubuntu Condensed, sans-serif' }}>
    <div className="header-text text-center">
      ...
      <div id="events" className="row">
        <EventItem title='Roadshow North' path='roadshow-north' date="1st April 2022" location="Launceston" registrationsOpen={false} />
        <EventItem title='Roadshow South' path='roadshow-south' date="8th April 2022" location="Hobart" registrationsOpen={true} />
        <EventItem title='TYLT' path='tylt' date="18th June 2022" location="Campbell Town" registrationsOpen={true} />
