      ...
      <div className="row">
        <div className="col-sm-6">
          <div className="white-bg">
            ...
            <p className="pddn-20-btm text-center"><Link to="/tyc-weekend/register" className="btn btn-main-ghost">Register for TYC Weekend</Link></p>
          </div>
        </div>
        <div className="col-sm-6">
          <div className="white-bg">
            ...
            <p className=" pddn-20-btm text-center"><Link to="/tyc-weekend/register-group" className="btn btn-main-ghost">Register As a Leader</Link></p>
          </div>
        </div>
      </div>
    </div>
