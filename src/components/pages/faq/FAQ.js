        ...
        <div className="container">
            <div className="row">
                <div className="col-md-12">
                    <div className="section-title">
                        <h2 className="text-center"><span>TYC FAQ Sheet</span></h2>
            ...
            <div className="row">
                <div className="col-sm-12">
                    ...
                    <h3 className="pddn-30-top">Who is responsible for my child?</h3>
                    <p className="subtitle">All youth will come to the events as part of a group. Your child will have to be registered under a youth group that has already registered its commitment to attend. This is because, since we are a small committee that can only do so much, accommodation and food (for TYC Weekend specifically) are almost entirely organised by the leaders of the groups attending.</p>
                    <p className="subtitle">The youth leaders overseeing the group your child stays with is primarily responsible for their safety.</p>
                    <p className="subtitle">Committee members and other volunteers on site will hold WWVP cards.</p>
                    ...
                    <p className="subtitle">TYC aims to centre everything around God’s word. Every year we draw our theme from the books of the Bible. If you have any specific questions on our theological convictions, please email us at <a href="mailto:tasyouthcon@gmail.com">tasyouthcon@gmail.com</a></p>
                    <p className="subtitle">We aim to focus on what unifies us as Christians. TYC events are multi-denominational and this is represented in those that attend – we have youth and leaders coming from Reformed, Anglican, Baptist, Presbyterian and Pentecostal Churches. </p>
                </div>
