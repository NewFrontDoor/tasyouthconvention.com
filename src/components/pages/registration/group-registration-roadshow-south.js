...
export default ({ show, currentPrice, submitRegistration, registeredGroups }) => {
  ...
  return (
    <div>
      <p>Use this form to register yourself and your youth group for Roadshow South.  Once your youth group has been approved, people in your youth group will be able to register for TYC.</p>
