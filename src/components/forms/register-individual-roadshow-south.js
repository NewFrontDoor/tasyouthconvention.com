...
const RegiserRoadShowSouthForm = ({ handleSubmit, pristine, reset, submitting, noYouthGroup, youthGroup, registeredGroups }) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <button className="btn btn-success" type="submit">Register for Roadshow South</button>
    </form>
  );
}

const RoadshowSouthReduxForm = reduxForm({
  form: 'registerIndividual',
  validate: validateForm
})(RegiserRoadShowSouthForm);
