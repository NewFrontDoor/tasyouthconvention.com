...
const RegisterIndividualForm = ({ handleSubmit, pristine, reset, submitting, noYouthGroup, registeredGroups }) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      {!noYouthGroup &&
        <Field id="field_youth_group" name="field_youth_group" label="Your Youth Group" placeholder="" component={registerDropdown} options={mappedGroups} validate={[val.required, val.minLength(5), val.maxLength(50)]} />
      }
      ...
      <button className="btn btn-success" type="submit">Register for TYC</button>
    </form>
  );
}
