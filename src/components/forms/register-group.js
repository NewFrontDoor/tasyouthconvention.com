...
const RegisterGroupForm = ({ handleSubmit, pristine, reset, submitting, registeredGroups }) => {
  return (
    <form onSubmit={handleSubmit}>
      ...
      <Field id="youthGroup" name="youthGroup" label="Your Youth Group" placeholder="Use this field to search for your group.  If it is not in the list, it will be created." component={registerAutocomplete} options={registeredGroups.map(g => decode(g.title))} validate={[val.required, val.minLength(5), val.maxLength(50)]} />
