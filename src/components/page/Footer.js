                ...
                <Link to="/#speakers">Speakers</Link>
						...
						<li>
							{isFrontPage ? (
								...
								<Link className="redLink" to="/#about-tyc">
									About
								</Link>
							)}
						</li>
						<li>
							{isFrontPage ? (
								...
								<Link className="redLink" to="/#events">
									Events
								</Link>
							)}
						</li>
						<li>
							<Link className="redLink" to="/FAQ">
								FAQ
							</Link>
						</li>
						<li>
							<Link className="redLink" to="/talks">
								Past Talks
							</Link>
						</li>
					</ul>
					<p className="copyright">
						Copyright <i className="fa fa-copyright"></i> 2022 - Tasmanian Youth Convention
					</p>
					<p className="copyright">
						Website by{" "}
						<a className="redLink" href="https://newfrontdoor.org/" target="_blank" rel="noreferrer noopener">
							New Front Door
						</a>
					</p>
				</div>
					...
					<ul className="list-inline social-buttons">
						<li>
							...
							<a
								...
								href="https://www.facebook.com/tasyouth/"
								target="_blank"
						...
						<li>
							...
							<a
								...
								href="https://www.instagram.com/tasyouthcon/"
								target="_blank"
								rel="noreferrer noopener"
							></a>{" "}
						</li>
...
export const FrontPageFooter = () => <Footer isFrontPage={true} />;

export const OtherPageFooter = () => <Footer isFrontPage={false} />;
