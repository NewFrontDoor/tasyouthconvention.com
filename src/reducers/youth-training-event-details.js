...
export default (state, action) => {
  switch (action.type) {
    case types.REQUESTING_YOUTH_TRAINING_EVENT_DETAILS:
      return Object.assign({}, state, { loading: true });
    case types.RECEIVED_YOUTH_TRAINING_EVENT_DETAILS:
      return Object.assign({}, state, { loading: false, details: normaliseEventDetails(action.details) });
    case types.RECEIVED_YOUTH_TRAINING_GROUP_INFORMATION:
...
export const getGroups = (state) => state.youthTrainingEventDetails.registeredGroups;
