...
const savingRegistration = () => ({
  type: types.SAVING_YOUTH_TRAINING_REGISTRATION
});

const errorSavingRegistration= (error) => ({
  type: types.ERROR_SAVING_YOUTH_TRAINING_REGISTRATION,
  error
});

const savedRegistration = (details) => ({
  type: types.SAVED_YOUTH_TRAINING_REGISTRATION,
  details
});

const savingPaymentDetails = () => ({
  type: types.SAVING_YOUTH_TRAINING_PAYMENT_DETAILS
});

const errorSavingPaymentDetails = (error) => ({
  type: types.ERROR_SAVING_YOUTH_TRAINING_PAYMENT_DETAILS,
  error
});

const savedPaymentDetails = (details) => ({
  type: types.SAVED_YOUTH_TRAINING_PAYMENT_DETAILS
});

export const resetIndividualRegistration = () => ({
  type: types.RESET_YOUTH_TRAINING_REGISTRATION
});
